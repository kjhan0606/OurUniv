...
RUNNER = ROOT / "scripts/run_cf4_aggregate_evidence_smc_v6_open_shared_schedule_production_grammar_debug_v2_parent_key_overlap_canonical_read_only_analysis_authorized_v6.sbatch"
STATUS = ROOT / "scripts/status_cf4_aggregate_evidence_smc_v6_open_shared_schedule_production_grammar_debug_v2_parent_key_overlap_canonical_read_only_analysis_authorized_v6.sh"
SOURCE = ROOT / "src/cf4_aggregate_evidence_smc_v6_open_shared_schedule_production_grammar_debug_v2_parent_key_overlap_canonical_read_only_analysis_authorized_v6.py"


def test_sbatch_exact_resources_and_dev_null():
    text = RUNNER.read_text()
    required = {
        "#!/bin/bash", "#SBATCH --job-name=cf4-parent-overlap-v1", "#SBATCH --partition=a40",
        "#SBATCH --nodelist=syn06", "#SBATCH --nodes=1", "#SBATCH --ntasks=1",
