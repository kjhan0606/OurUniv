...
rm -f logs/lg_stage4_done.flag
# Virgo-perpendicular completion seeds x several fine seeds (velocity variety)
for cs in 48 77 82 141 74; do
  for fs in 1 2 3; do
...
echo ALL_DONE > logs/lg_stage4_done.flag
