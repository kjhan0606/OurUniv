...
CANONICAL_CONFIG = ROOT / "config/cf4_lg_highk_terminal_publication_repair_program_v2.json"
EXPECTED_CONFIG_SHA = "f93119f8efea564c970a25790b49060a6110919884bd10fbdf3405d755e86944"
CONFIG_SCHEMA = "ouruniv-cf4-lg-highk-terminal-publication-repair-program-v2"
GRANT_SCHEMA = "ouruniv-cf4-lg-highk-terminal-publication-repair-grant-v2"
CONFIG_KEYS = {
...
EXPECTED_PARENT = "500ed0eaa8a37f661cc284b9432dddc6711fa2af"
SEALED_RUNTIME_COMMIT = "51877b7ebba8601216411ef4e3d36623016ec625"
...
def _parse_config(payload: bytes) -> dict[str, Any]:
    ...
    if lineage.get("required_parent_commit") != EXPECTED_PARENT \
            or lineage.get("sealed_runtime_commit") != SEALED_RUNTIME_COMMIT \
            ...
            or execution.get("grant_path") != "config/cf4_lg_highk_terminal_publication_repair_grant_v2.json" \
            or execution.get("future_result_record_path") != "config/cf4_lg_highk_terminal_publication_repair_result_record_v2.json":
