...
PROGRAM = ROOT / "config/cf4_aggregate_evidence_smc_v6_open_shared_schedule_production_grammar_debug_v2_parent_key_overlap_canonical_read_only_analysis_authorized_program_v2.json"
GRANT = ROOT / "config/cf4_aggregate_evidence_smc_v6_open_shared_schedule_production_grammar_debug_v2_parent_key_overlap_canonical_read_only_analysis_execution_grant_v2.json"
RELEASE = Path("/gpfs/kjhan/CF4/recon/linear_cr/aggregate_evidence_smc_v6_open_shared_schedule_production_grammar_debug_v2_parent_key_overlap_canonical_read_only_analysis_execution_release_v2.json")
MANIFEST = Path("/gpfs/kjhan/CF4/recon/linear_cr/aggregate_evidence_smc_v6_open_shared_schedule_production_grammar_debug_v2_parent_key_overlap_canonical_read_only_analysis_execution_manifest_v2.json")
RECEIPT_ROOT = Path("/gpfs/kjhan/CF4/recon/linear_cr/aggregate_evidence_smc_v6_open_shared_schedule_production_grammar_debug_v2_parent_key_overlap_canonical_read_only_analysis_receipts_v2")
...
REMEDIATION_DESIGN = ROOT / "config/cf4_aggregate_evidence_smc_v6_open_shared_schedule_production_grammar_debug_v2_parent_key_overlap_canonical_read_only_analysis_authorized_wrapper_remediation_design_v2.json"
PAIR_DESIGN = ROOT / "config/cf4_aggregate_evidence_smc_v6_open_shared_schedule_production_grammar_debug_v2_parent_key_overlap_canonical_read_only_analysis_grant_release_manifest_design_v2.json"
PAIR_DESIGN_ERRATUM = ROOT / "config/cf4_aggregate_evidence_smc_v6_open_shared_schedule_production_grammar_debug_v2_parent_key_overlap_canonical_read_only_analysis_grant_release_manifest_design_v2_erratum_v1.json"
...
REMEDIATION_DESIGN_SHA = "6ecc335da8218fdb422d29ea7bbdf8ac60dc8d1c187aa37397a588e30c06c679"
REMEDIATION_DESIGN_COMMIT = "db66da76a0004e1e94192bbca6c404d35eee55c4"
PAIR_DESIGN_SHA = "23003ea7109f88e00a4c131685ea2822a7e81f3b2b3e3011aa9fd89801647221"
PAIR_DESIGN_COMMIT = "7aba8eefa53e4754b9ec772bea39ee9e79a691d0"
PAIR_DESIGN_ERRATUM_SHA = "d15777c34ba350ad62556eb1e9d72e1e914c5b36386ffa87a99c11ebf2e5238c"
PAIR_DESIGN_ERRATUM_COMMIT = "c9f462b478f0f7dc112c5a7431d6d456d3ead2d1"
...
def _validate_program(program_file: SnapshotFile) -> dict[str, Any]:
    ...
    if (
        program.get("schema") != "ouruniv-cf4-v6-open-parent-key-overlap-canonical-read-only-analysis-authorized-program-v2"
        or program.get("status") != "frozen_v2_program_execution_false_until_sealed_v2_pair_grant_and_audits"
        or program.get("date") != "2026-08-23"
        or program.get("purpose") != "Freeze the exact no-argument execution-false v2 program binding for the remediated one-shot memory-only parent/key overlap analysis."
    ):
    ...
    expected_lineage = {
        ...
        "grant_release_manifest_design_commit": PAIR_DESIGN_COMMIT,
        ...
        "inherited_science_authorization_design_sha256": AUTHORIZATION_DESIGN_SHA,
    ...
    expected_order = (
        ("src/cf4_aggregate_evidence_smc_v6_open_shared_schedule_production_grammar_debug_v2_parent_key_overlap_canonical_read_only_analysis_authorized_v2.py", "0644"),
        ("scripts/run_cf4_aggregate_evidence_smc_v6_open_shared_schedule_production_grammar_debug_v2_parent_key_overlap_canonical_read_only_analysis_authorized_v2.sbatch", "0755"),
        ("scripts/status_cf4_aggregate_evidence_smc_v6_open_shared_schedule_production_grammar_debug_v2_parent_key_overlap_canonical_read_only_analysis_authorized_v2.sh", "0755"),
        ("tests/test_cf4_aggregate_evidence_smc_v6_open_shared_schedule_production_grammar_debug_v2_parent_key_overlap_canonical_read_only_analysis_authorized_v2.py", "0644"),
        ("tests/test_cf4_aggregate_evidence_smc_v6_open_shared_schedule_production_grammar_debug_v2_parent_key_overlap_canonical_read_only_analysis_authorized_v2_runner.py", "0644"),
    )
    ...
    expected_next = {"canonical_analysis_execution_authorized": False, "canonical_artifact_read_authorized": False, "external_pair_and_committed_grant_audits_required": True, "immediate": "exact_six_v2_implementation_precommit_audit_only", "receipt_creation_authorized": False, "slurm_submission_authorized": False}
...
def _validate_pair(program_file: SnapshotFile, grant_file: SnapshotFile, release_file: SnapshotFile, manifest_file: SnapshotFile, program: Mapping[str, Any]) -> tuple[dict[str, Any], dict[str, Any], dict[str, Any]]:
    ...
    if (
        grant.get("schema") != "ouruniv-cf4-v6-open-parent-key-overlap-canonical-read-only-analysis-execution-grant-v2"
    ...
    if (
        release.get("schema") != "ouruniv-cf4-v6-open-parent-key-overlap-canonical-read-only-analysis-execution-release-v2"
        or release.get("status") != "complete_pass_external_postcommit_lineage_audit"
    ):
        raise AuthorizationError("release identity changed")
    if (
        manifest.get("schema") != "ouruniv-cf4-v6-open-parent-key-overlap-canonical-read-only-analysis-execution-manifest-v2"
    ...
    if (
        payload.get("schema") != "ouruniv-cf4-v6-open-parent-key-overlap-canonical-read-only-analysis-execution-release-payload-v2"
    ...
    release_id = hashlib.sha256(
        ("ouruniv-parent-key-overlap-release-v2\0" + PAIR_DESIGN_COMMIT + "\0" + REMEDIATION_DESIGN_SHA + "\0" + program_file.sha256).encode()
    ).hexdigest()
    manifest_id = hashlib.sha256(
        ("ouruniv-parent-key-overlap-manifest-v2\0" + PAIR_DESIGN_COMMIT + "\0" + release_id).encode()
    ).hexdigest()
    grant_id = hashlib.sha256(
        ("ouruniv-parent-key-overlap-grant-v2\0" + PAIR_DESIGN_COMMIT + "\0" + release_file.sha256 + "\0" + manifest_file.sha256 + "\0" + program_file.sha256).encode()
    ).hexdigest()
...
def _verify_fixed_local_pins() -> None:
    if (
        PAIR_DESIGN_ERRATUM.relative_to(ROOT) != Path("config/cf4_aggregate_evidence_smc_v6_open_shared_schedule_production_grammar_debug_v2_parent_key_overlap_canonical_read_only_analysis_grant_release_manifest_design_v2_erratum_v1.json")
        or PAIR_DESIGN_ERRATUM_COMMIT != "c9f462b478f0f7dc112c5a7431d6d456d3ead2d1"
    ):
        raise AuthorizationError("pair design erratum path or direct-parent commit pin changed")
    for path, digest, mode in (
        ...
        (PAIR_DESIGN_ERRATUM, PAIR_DESIGN_ERRATUM_SHA, 0o644),
...
def _validate_marker(name: str, value: Mapping[str, Any], *, bundle: AuthorizationBundle | None = None, snapshot_sha: str | None = None) -> None:
    ...
    contracts = {
        "RUNNING": (
            ...
            "ouruniv-cf4-v6-open-parent-key-overlap-read-only-analysis-receipt-running-v2",
            "running_authorized_read_only_in_memory_analysis",
        ),
        "COMPLETE": (
            common | {"schema", "status", "analysis_return_validated_in_process"},
            "ouruniv-cf4-v6-open-parent-key-overlap-read-only-analysis-receipt-complete-v2",
            "complete_valid_provenance_and_in_memory_analysis_postvalidation",
        ),
        "FAILED": (
            common | {"schema", "status", "failure_class", "checkpoint"},
            "ouruniv-cf4-v6-open-parent-key-overlap-read-only-analysis-receipt-failed-v2",
    ...
    try:
        with _masked_signals():
          try:
            ...
            hook("after_snapshot")
            _assert_lease_chain(lease)
            running = {"schema": "ouruniv-cf4-v6-open-parent-key-overlap-read-only-analysis-receipt-running-v2", "status": "running_authorized_read_only_in_memory_analysis", "grant_id": bundle.grant["grant_id"], "release_id": bundle.release["release_id"], "manifest_id": bundle.manifest["manifest_id"], "snapshot_sha256": snapshot_sha}
...
def _seal_failed_at(bundle: AuthorizationBundle, item: CreatedDirectory, snapshot_sha: str, *, lease: ReceiptLease | None = None, checkpoint: str, require_canonical_name: bool) -> None:
    ...
    try:
        ...
        pass
    value = {"schema": "ouruniv-cf4-v6-open-parent-key-overlap-read-only-analysis-receipt-failed-v2", "status": "failed_invalid_provenance_read_or_analysis_execution", **_marker_common(bundle, snapshot_sha), "failure_class": "invalid_provenance_read_or_analysis_execution", "checkpoint": checkpoint}
...
def _seal_complete(lease: ReceiptLease) -> None:
    with _masked_signals():
        ...
        value = {"schema": "ouruniv-cf4-v6-open-parent-key-overlap-read-only-analysis-receipt-complete-v2", "status": "complete_valid_provenance_and_in_memory_analysis_postvalidation", **_marker_common(lease.bundle, lease.snapshot_sha), "analysis_return_validated_in_process": True}
...
def run_authorized_canonical_parent_key_overlap_read_only_analysis_v2() -> Mapping[str, Any]:
...
def main() -> int:
    ...
    if mode is None and child is None:
        run_authorized_canonical_parent_key_overlap_read_only_analysis_v2()
        return 0
