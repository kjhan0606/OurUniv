...
out=/gpfs/kjhan/IllustrisTNG/TNG100-1/training/tng100_simba_v10_twocomponent_smoke
stochastic=/gpfs/kjhan/IllustrisTNG/TNG100-1/training/tng100_simba_v8_observable_context/validation_checkpoints/step_010000.pt
cd "$repo"
python src/hong2021_residual_v10_twocomponent.py train \
 --stochastic-checkpoint "$stochastic" \
 ...
 --out "$out" --steps 20 --validation-every 10 --smoke-limit 8 --workers 0
python src/hong2021_residual_v10_twocomponent.py sample \
 ...
 --correction-checkpoint "$out/validation_checkpoints/step_000020.pt" \
 --stochastic-checkpoint "$stochastic" --out "$out/smoke_sample.h5" \
