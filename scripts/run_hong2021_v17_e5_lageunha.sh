...
out=$tng/training/tng100_simba_swift_v17_e5_band_balanced_edm
cd "$repo"
export PYTHONPATH=$repo/src

python src/hong2021_v17_edm.py \
  --registry config/hong2021_v17_development_program.json --repo "$repo" \
