...
out=/gpfs/kjhan/IllustrisTNG/TNG100-1/training/tng100_simba_v9_tail_balanced_smoke
cd "$repo"
python src/hong2021_residual_v9_tail.py train \
  --initialize /gpfs/kjhan/IllustrisTNG/TNG100-1/training/tng100_simba_v8_observable_context/validation_checkpoints/step_010000.pt \
...
python src/hong2021_residual_v9_tail.py sample \
  ...
  --checkpoint "$out/validation_checkpoints/step_000020.pt" \
  --out "$out/smoke_sample.h5" --indices 0 --ensemble 2 --sampling-steps 4
